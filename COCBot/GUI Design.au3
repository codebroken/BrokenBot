...
$btnLocateCamp = GUICtrlCreateButton("Army Camp", 213, 297, 83, 25)
GUICtrlSetOnEvent(-1, "btnLocateCamp")
$btnLab = GUICtrlCreateButton("Laboratory", 299, 297, 83, 25)
...
$lblsearchdisconnected = GUICtrlCreateLabel("Disconnected :", 220, 98, 100, 17)
$lblresultsearchdisconnected = GUICtrlCreateLabel("0", 318, 98, 60, 17, $SS_RIGHT)
$lblsearchcost = GUICtrlCreateLabel("Search Cost :", 220, 113, 100, 17)
$lblresultsearchcost = GUICtrlCreateLabel("0", 318, 113, 60, 17, $SS_RIGHT)
$lblruntime = GUICtrlCreateLabel("Bot Run Time :", 220, 128, 100, 17)
